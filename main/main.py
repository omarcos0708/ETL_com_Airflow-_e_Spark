...
# Configuração das conexões com PostgreSQL e HDFS
...
def extract_transform_load():
    ...
    # Salvando dados transformados nas camadas bronze, silver e gold
    ...
    # Validação dos dados nas camadas bronze, silver e gold
